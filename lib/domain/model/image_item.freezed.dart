...
abstract class $ImageItemCopyWith<$Res> {
  ...
  @useResult
  $Res call({String tags, String imageUrl, int id});
}
...
class _$ImageItemImpl with DiagnosticableTreeMixin implements _ImageItem {
  const _$ImageItemImpl(
      {required this.tags, required this.imageUrl, required this.id});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ImageItem(tags: $tags, imageUrl: $imageUrl, id: $id)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, tags, imageUrl, id);
